...
with st.sidebar:
    ...
    # Campo para el teléfono de WhatsApp
...
# --- RESULTADOS PRINCIPALES (Métricas en grande) ---
st.subheader(f"👤 Cliente: {nombre}")

# Ahora creamos 4 columnas para que quepa el monto entregado también
...
with col4:
    # Mostramos la ganancia con un color verde (delta)
...
with col_btn:
    st.link_button("📱 Enviar Plan por WhatsApp", link_wsp)

st.info("💡 Sugerencia: El link de WhatsApp funcionará mejor si incluyes el código de país en el celular.")
