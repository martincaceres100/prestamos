...
with st.sidebar:
    ...
    # La fecha_prestamo es hoy, la primera cuota será +30 días
...
# Creamos 5 columnas para que quepan todas las métricas
...
with col2:
    # Mostramos la cantidad de cuotas como una métrica grande
    st.metric("Cantidad de Cuotas", f"{int(cuotas)}")
